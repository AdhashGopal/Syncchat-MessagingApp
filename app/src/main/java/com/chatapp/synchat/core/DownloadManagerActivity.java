...
//        deleteDir(new File(Environment.getExternalStorageDirectory() + "/aChat"));
    ...
    class DownloadMethodTwo extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            try {
                deleteDir(new File(Environment.getExternalStorageDirectory() + "/SynChat"));
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                pathFolder = Environment.getExternalStorageDirectory() + "/SynChat";
                pathFile = pathFolder + "/SynChat.apk";

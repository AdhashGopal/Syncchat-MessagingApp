 ...
 */
public class CustomMultiItemsBgAdapter extends RecyclerView.Adapter<CustomMultiItemsBgAdapter.MultiItemsViewHolder> {
     ...
     * @param dataList list of value will be shown
     */
    public CustomMultiItemsBgAdapter(Context mContext, List<MultiTextDialogPojo> dataList) {
    ...
    public MultiItemsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.adapter_multi_items_bbg, parent, false);

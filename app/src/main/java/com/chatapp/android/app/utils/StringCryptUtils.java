...
/**
 * created by  Adhash Team on 7/25/2017.
 */
...
public class StringCryptUtils {
    ...
    public StringCryptUtils() throws NoSuchAlgorithmException, NoSuchPaddingException {
    ...
    public String encryptSimple(String _plainText, String _key, String _iv)
        ...
        return encryptDecrypt(_plainText, StringCryptUtils.SHA256(_key, 32), EncryptMode.ENCRYPT, _iv);
    }
    ...
    public String decryptSimple(String _encryptedText, String _key, String _iv)
            ...
            InvalidAlgorithmParameterException, IllegalBlockSizeException,
            BadPaddingException, NoSuchAlgorithmException {
        return encryptDecrypt(_encryptedText, StringCryptUtils.SHA256(_key, 32), EncryptMode.DECRYPT, _iv);
    }

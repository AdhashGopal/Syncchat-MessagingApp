 ...
 */
public abstract class ChatappImageLoader {
    private static final String TAG = "ChatappImageLoader";
    private static final int FADE_IN_TIME = 200;

    private ChatappCache mImageCache;
    ...
    protected ChatappImageLoader(Context context, int imageSize) {
     ...
     * {@link ChatappImageLoader#processBitmap(Object)} to define the processing logic). If the image is
    ...
    /**
     * Adds an {@link ChatappCache} to this image loader.
     *
    ...
    public void addImageCache(FragmentManager fragmentManager, float memCacheSizePercent) {
        mImageCache = ChatappCache.getInstance(fragmentManager, memCacheSizePercent);
    }
     ...
     *            {@link ChatappImageLoader#loadImage(Object, ImageView)}

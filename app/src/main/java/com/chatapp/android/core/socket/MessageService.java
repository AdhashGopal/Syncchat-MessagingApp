...
import com.chatapp.android.app.PinEnterActivity;
import com.chatapp.android.app.ReLoadingActivityNew;
import com.chatapp.android.app.UserInfo;
import com.chatapp.android.app.calls.CallAck;
...
import com.chatapp.android.app.utils.DateChangeBroadcastReceiver;
...
import com.chatapp.android.app.utils.StringCryptUtils;
...
import com.chatapp.android.core.database.DatabaseClassForDB;
...
import com.chatapp.android.core.message.MesssageObjectReceiver;
import com.chatapp.android.core.message.OfflineMessageHandler;
...
//        timeFilter.addAction(Intent.ACTION_TIME_TICK);
    ...
    private void startInForeground() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
                .setSmallIcon(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O ? R.drawable.ic_app_notification : R.drawable.logo_initial_loader)
                .setContentTitle("aChat")
                .setContentText("Adani Messaging Application")
//                .setTicker("TICKER")
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            @SuppressLint("WrongConstant") NotificationChannel channel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, "aChat", NotificationManager.IMPORTANCE_DEFAULT);
...
//                            .setDefaults(Notification.DEFAULT_ALL)
    ...
    public void createNotification(String title, String message) {
        ...
        mBuilder.setSmallIcon(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O ? R.drawable.ic_app_notification : R.drawable.logo_initial_loader);
    ...
    private void adminApprovalNotification(String data) {
        try {
            ...
            if (!id.equalsIgnoreCase(uniqueCurrentID)) {
                ...
                createNotification("aChat", "Admin Approved your account");
            ...
            if (to.equalsIgnoreCase(uniqueCurrentID) && callStatus.equals(MessageFactory.CALL_STATUS_CALLING + "")) {
                ...
                if (!CallsActivity.isStarted && !IncomingCallActivity.isStarted) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        ...
                        NotificationChannel notificationChannel = new NotificationChannel(String.valueOf(555), "aChat Call", NotificationManager.IMPORTANCE_HIGH);
                        notificationChannel.enableLights(true);
                        if (notificationCallManager != null) {
                    ...
                    notificationBuilder.setSmallIcon(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O ? R.drawable.ic_app_notification : R.drawable.logo_initial_loader)
    ...
    private void missedCallNotify(String data) {
        try {
            ...
            if (to.equalsIgnoreCase(uniqueCurrentID) && callStatus.equals("2")) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    @SuppressLint("WrongConstant")
                    NotificationChannel notificationChannel = new NotificationChannel(String.valueOf(5556), "aChat Call", NotificationManager.IMPORTANCE_HIGH);
                    notificationChannel.enableLights(true);
                    if (notificationCallManager != null) {
                        notificationCallManager.createNotificationChannel(notificationChannel);
                    }

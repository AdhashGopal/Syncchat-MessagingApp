...
public class WebSocketRTCClient implements AppRTCClient, WebSocketChannelEvents {
    ...
    public WebSocketRTCClient(SignalingEvents events, Context context) {
    ...
    private String randomId() {
        ...
        return new String(Base64.encode((deviceId).getBytes(), Base64.DEFAULT));
    }

    // Helper functions to get connection, post message and leave message URLs
    private String getConnectionUrl(RoomConnectionParameters connectionParameters) {
        return connectionParameters.roomUrl + "/" + ROOM_JOIN + "/" + connectionParameters.roomId + "/" + randomId() + getQueryString(connectionParameters);
...
//    wsClient.connect("http://v71.sdnsbox.com/sc_webrtc_message", "http://v71.sdnsbox.com");
